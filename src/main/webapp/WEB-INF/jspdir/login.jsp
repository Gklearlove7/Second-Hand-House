...
<div class="content">
    <div class="width1190">
        <div class="reg-logo">
            <form id="signupForm" method="post" action="/user/login_judge" class="zcform"   οnsubmit="return CheckPost();">
                <p class="clearfix">
                    <label class="one" for="agent">登陆账户：</label>
                    <input id="agent" name="user_account" type="text" class="required" value placeholder="请输入您的用户名" />
                </p>
                <p class="clearfix">
                    <label class="one"  for="password">登录密码：</label>
                    <input id="password" name="user_password" type="password" class="{required:true,rangelength:[8,20],}" value placeholder="请输入密码" />
                </p>
                <p class="clearfix"><input class="submit" id="submit" type="submit" value="立即登录"/></p>
                <div style=" text-align: right; margin-right: 15%"><a href="/user/forget_password" ><button type="button" id="forget" >忘记密码</button ></a></div>
            </form>
            ...
            <div class="reg-logo-right">
                <h3>如果您没有账号，请</h3>
                <a href="/user/goregister" class="logo-a">立即注册</a>
            </div><!--reg-logo-right/-->
            <div class="clears"></div>
        </div><!--reg-logo/-->
    </div><!--width1190/-->
