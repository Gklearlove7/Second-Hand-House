    ...
    <div class="width1190">
        <div class="reg-logo">
            <form id="signupForm"  class="zcform">
                ...
                <span id="info" style="display:none;position:absolute;z-index: 1;font-size: 15px;margin-top: 10px;opacity: 0.6;">&nbsp;&nbsp;&nbsp;邮箱或密码均不能为空</span>
                <p class="clearfix">
                    <label class="one" for="user_account">账号：</label>
                    <input id="user_account" name="user_account" type="text" class="required" value placeholder="请输入您的账号" />
                </p>
                <p class="clearfix">
                    <label class="one" for="new_password">新密码：</label>
                    <input id="new_password" name="new_password" type="password" class="required" value placeholder="请输入您的新密码" />
                </p>

                <p class="clearfix">
                    <label class="one"  for="captcha">验证码：</label>
                    <input id="captcha" name="captcha" type="text" class="required" value placeholder="请输入验证码" />
                    <button type="button" name="btn"
                            class="btn btn-default" id="btn_forget" onclick="get_captcha()"> 发送验证码</button>
                </p>

                <button class="email_submit" type="button" onclick="forget_password_modify()">
                    更改
                </button>
            </form>
            <div class="reg-logo-right">
                <h3>无需更改？返回到登录页面</h3>
                <a href="/user/gologin" class="logo-a">返回登录页面</a>
            </div><!--reg-logo-right/-->
            <div class="clears"></div>
        </div><!--reg-logo/-->
    </div><!--width1190/-->
