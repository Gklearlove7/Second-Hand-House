        ...
        <div class="vip-left">
            <div class="vipNav">
                ...
                <dl>
                    ...
                    <dd>
                        <a href="/user/userinfo">我的资料</a>
                        <a href="/user/modify_password_page" class="vipNavCur">账户密码设置</a>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <label class="butt" id="butt">
                            <button class="member_mod_buttom" onclick="change_password()">完成修改</button>
                        </label>
                    </td>
                </tr>
                </tbody>
