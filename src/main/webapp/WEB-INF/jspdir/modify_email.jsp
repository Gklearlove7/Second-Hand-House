    ...
    <div class="width1190">
        <div class="reg-logo">
            ...
            <span id="info" style="display:none;position:absolute;z-index: 1;font-size: 15px;margin-top: 10px;opacity: 0.6;">&nbsp;&nbsp;&nbsp;邮箱或密码均不能为空</span>
                <p class="clearfix">
                    <label class="one" for="new_email">新邮箱：</label>
                    <input id="new_email" name="new_email" type="email" class="required" value placeholder="请输入您的新邮箱" />
                </p>
                ...
                <p class="clearfix">
                    ...
                    <button type="button" name="btn"
                            class="btn btn-default" id="btn"> 发送验证码</button>
                </p>

                <button class="email_submit" type="button" onclick="check_mail()">
                    更改
                </button>
            </form>
            <div class="reg-logo-right">
                <h3>不想修改了？返回个人信息页面</h3>
                <a href="/user/userinfo" class="logo-a">返回个人信息</a>
            </div><!--reg-logo-right/-->
            <div class="clears"></div>
        </div><!--reg-logo/-->
    </div><!--width1190/-->
    ...
    $(function(){
        $("#btn").click(function(){
                if($("#new_email").val()){
                    $.ajax({
                        type:"POST",
                        url :"/user/send?random"+Math.random(),
                        data:{
