...
<head>
    ...
    <script type="text/javascript" src="/js/myjs_seller.js"></script>
...
<div class="content">
    <div class="width1190">
        <div class="vip-left">
            <div class="vipNav">
                ...
                <dl>
                    ...
                    <dd>
                        <a href="user_guanzhu.html">添加出售</a>
        ...
        <div class="vip-right">
            <h3 class="vipright-title">添加房子信息</h3>
            <form action="#" method="get">
                <dl class="vip-touxiang">
                    <dd>
                        <div class="sctx"><a class="active" href="#" title="" onclick="add_house('${requestScope.new_house_id}')">添加房子图片</a></div>
                        <input type="file" name="file" id="file_pic" accept="image/*" style="display: none" >
            ...
            <table class="grinfo">
                ...
                <tr>
                    <th><span class="red">*</span> 房子所在小区：</th>
                    <td>
                        <input class="inp inw" type="text" id="house_community"  maxlength="20">
                    </td>
                </tr>
                <tr>
                    <th><span class="red">*</span> 房子户型：</th>
                    <td>
                        <input class="inp inw" type="text" maxlength="20"  id="house_type" >
                    </td>
                </tr>
                <tr>
                    <th><span class="red">*</span> 房子所在区县：</th>
                    <td>
                        <div id="bee_countys1">
                            <select id="house_address" onchange="mod_street($('#bee_county1').val(),'1');">
                                <option value="未央区">未央</option><option value="雁塔区">雁塔</option><option value="莲湖区">莲湖</option><option value="长安区">长安</option><option value="灞桥区">灞桥</option><option value="碑林区">碑林</option><option value="阎良区">阎良</option><option value="高陵区">高陵</option><option value="临潼区">临潼</option><option value="新城区">新城</option><option value="西安周边">西安周边</option></select>
                        </div>
                    </td>
                </tr>
                <tr>
                    <th><span class="red">*</span> 房子总价：</th>
                    <td>
                        <input class="inp inw" type="text" id="house_money" value="" maxlength="20">元
                    </td>
                </tr>
                <tr>
                    <th><span class="red">*</span> 房子定金：</th>
                    <td>
                        <input class="inp inw" type="text" id="house_deposit" value="" maxlength="20">元
                    </td>
                </tr>
                <tr>
                    <th><span class="red">*</span> 房子面积：</th>
                    <td>
                        <input class="inp inw" type="text" id="house_area" value="" maxlength="20" >平方米
                    </td>
                </tr>
                <tr>
                    <th><span class="red">*</span> 房子所在楼层：</th>
                    <td>
                        <input class="inp inw" type="text" id="house_floor" value="" maxlength="3" >层
                    </td>
                </tr>
                <tr>
                    <th><span class="red">*</span> 房子简述：</th>
                    <td>
                        <input class="inp inw" type="text" id="house_info" value="" maxlength="20" >
                    </td>
                </tr>
                <tr>
                    <th><span class="red">*</span> 所在小区简述：</th>
                    <td>
                        <input class="inp inw" type="text" id="house_community_info" value="" maxlength="20" >
                    </td>
                </tr>
                <tr>
                    <th valign="top"><span class="red">*</span>房子描述：</th>
                    <td>
                        <textarea id="house_detail_info" class="grtextarea"></textarea>
                        <br>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <label class="butt" id="butt">
                            <button class="member_mod_buttom" onclick="add_new_house('${requestScope.new_house_id}','${sessionScope.user.user_id}','${sessionScope.user.user_name}')">点击上传</button>
                        </label>
                    </td>
                </tr>
                </tbody>
